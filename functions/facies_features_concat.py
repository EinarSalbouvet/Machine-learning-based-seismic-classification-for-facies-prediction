...
def concat_features_RelAI_Seis_SeisInv(
    df_facies_wells, feature_list_RelAI_Seis_SeisInv
):
    ...
    features = features.rename(columns={0: "relai", 1: "seis", 2: "seis_inv"})
    features
...
def concat_features_Seis_SeisInv(df_facies_wells, feature_list_Seis_SeisInv):
    ...
    features = features.rename(columns={0: "seis", 1: "seis_inv"})
    features
...
def concat_features_RelAI_Seis_Envel_InstFreq(
    df_facies_wells, feature_list_RelAI_Seis_Envel_InstFreq
):
    ...
    features = features.rename(
        columns={0: "relai", 1: "seis", 2: "envel", 3: "inst_freq"}
    )
    features
...
def concat_features_RelAI_Seis_SeisInv_Depth(
    df_facies_wells, feature_list_RelAI_Seis_SeisInv_Depth
):
    """The function concatenate features (RelAI, Seismic, Seismic Inversion) with Facies
    ...
    features = features.rename(
        columns={0: "relai", 1: "seis", 2: "seis_inv", 3: "depth"}
    )
    features
...
def concat_features_RelAI_Seis_Envel_InstFreq_Depth(
    df_facies_wells, feature_list_RelAI_Seis_Envel_InstFreq_Depth
):
    """The function concatenate features (RelAI, Seismic, Envelope, InstFreq) with Facies
    ...
    XX0, XX1, XX2, XX3, XX4 = create_empty_lists(
        len(feature_list_RelAI_Seis_Envel_InstFreq_Depth)
    )
    YY1 = []
    ...
    features = features.rename(
        columns={0: "relai", 1: "seis", 2: "envel", 3: "inst_freq", 4: "depth"}
    )
    features
...
def concat_features_RelAI_Seis_SeisInv_SpecDec(
    df_facies_wells, feature_list_RelAI_Seis_SeisInv_SpecDec
):
    """The function concatenate features (RelAI, Seismic, Envelope, InstFreq) with Facies
    ...
    XX0, XX1, XX2, XX3 = create_empty_lists(
        len(feature_list_RelAI_Seis_SeisInv_SpecDec)
    )
    YY1 = []
    ...
    features = features.rename(
        columns={0: "relai", 1: "seis", 2: "seis_inv", 3: "spec"}
    )
    features
...
def concat_features_RelAI_Seis_Envel_InstFreq_SeisInv(
    df_facies_wells, feature_list_RelAI_Seis_Envel_InstFreq_SeisInv
):
    """The function concatenate features (RelAI, Seismic, Envelope, InstFreq) with Facies
    ...
    features = features.rename(
        columns={0: "relai", 1: "seis", 2: "envel", 3: "inst_freq", 4: "seis_inv"}
    )
    features
